...
export default function GuidedChatPage() {
  ...
  if (!hasActiveSubscription) {
    return (
      <div className="space-y-6"> {/* Added spacing */}
        <h1 className="text-2xl font-semibold text-foreground mb-6">Guided Chat Flows</h1>
        ...
        <div className="bg-card border-l-4 border-yellow-500 text-yellow-500 p-4 rounded shadow-md" role="alert">
          ...
          <p className="text-muted-foreground">You need an active subscription to manage Guided Chat Flows.</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-semibold text-foreground">Manage Guided Chat Flows</h1>
      ...
      <div className="bg-card shadow rounded-lg p-6 border border-border">
         <GuidedChatManager /> {/* This component will need styling too */}
      </div>
    </div>
  );
}
