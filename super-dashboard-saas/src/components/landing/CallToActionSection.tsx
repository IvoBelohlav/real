...
const CallToActionSection: React.FC = () => {
  ...
  return (
    <motion.section
      ...
      className="py-16 md:py-24 bg-gradient-to-r from-purple-600 to-indigo-700 text-white px-4 relative overflow-hidden" // Matches the provided style
    >
      {/* Background effects */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <Link href="/register">
            {/* Using span with Tailwind classes instead of Button component for this specific style */}
