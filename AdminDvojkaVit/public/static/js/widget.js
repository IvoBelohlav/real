...
(function(window) {
  ...
  const DEFAULT_CONFIG = {
    ...
    containerId: 'dvojkavit-widget-container',
    avatarUrl: '',
    cssOverrides: '',
  ...
  class DvojkavitChatWidget {
    ...
    init(userConfig) {
      ...
      if (!containerElement) {
        console.error(`Dvojkavit Chat Widget: Container with ID '${this.config.containerId}' not found`);
        return;
      }

      // Create and inject widget elements
      this.createWidgetElements(containerElement);
     ...
     */
    createWidgetElements(containerElement) {
      // Create container
      ...
      // Add container to provided container element
